...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item){
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",new ResourceLocation(TutorialMod.MOD_ID, "item/" + item.getId().getPath()));
    }

            //Custom Method. This method ensures that the tools have the
            //characteristic 3D look of minecraft tools when held, rather
            // than the flat look that simpleBlockItem will provide.
